...
bind_devices_to_vfio_pci()
{
    ...
    echo $passwd | sudo -S $RTE_SDK/usertools/dpdk-devbind.py -b vfio-pci $PCI_PATH --noiommu-mode
}
...
unbind_dpdk() {
    ...
    echo $passwd | sudo -S ${RTE_SDK}/usertools/dpdk-devbind.py -b vmxnet3 $PCI_PATH
}
